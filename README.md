...
Симулятор ядерного реактора на Python с использованием PyTorch. Включает физически корректные модели нейтронной кинетики, теплообмена и систему управления.
